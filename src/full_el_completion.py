...
class ELModule(nn.Module):
    def __init__(self, module_name, dim, nb_classes, nb_individuals, nb_roles, transitive_ids = None):
        super().__init__()
...
class FullELModel(EmbeddingELModel):
    ...
    def init_modules(self):
        ...
        for i in range(self.num_models):
            module = ELModule(self.module_name, self.embed_dim, nb_classes, nb_individuals, nb_roles, transitive_ids = self.rbox_data["transitiveproperty"])

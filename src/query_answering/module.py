...
class ELBEQAModule(nn.Module):
    ...
    def query_1p(self, data, test=False):
        return L.query_1p_loss(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed, self.margin, test)

    def query_2p(self, data, test=False):
        return L.query_2p_loss(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed, self.margin, test)

    def query_3p(self, data, test=False):
        return L.query_3p_loss(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed, self.margin, test)
    ...
    def query_ip(self, data, test=False):
        return L.query_ip_loss(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed, self.margin, test)

    def query_inp(self, data, test=False):
        return L.query_inp_loss(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed, self.margin, test)
    ...
    def embedding_1p(self, data, test=False):
        return E.embedding_1p(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed)

    def embedding_2p(self, data, test=False):
        return E.embedding_2p(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed)

    def embedding_3p(self, data, test=False):
        return E.embedding_3p(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed)
    ...
    def embedding_ip(self, data, test=False):
        return E.embedding_ip(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed)

    def embedding_inp(self, data, test=False):
        return E.embedding_inp(data, self.class_embed, self.class_offset, self.rel_embed, self.scale_embed)
    ...
    def forward(self, init, tails, task_name, test=False):

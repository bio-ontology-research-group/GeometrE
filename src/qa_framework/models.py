...
class KGReasoning(nn.Module):
    ...
    def get_embedding_fn(self, task_name):
        ...
        return {
            ...
            "1pt": self.embedding_1pt,
            "1pi": self.embedding_1pi,
            "2p": self.embedding_2p,
            "2pt": self.embedding_2pt,
            "2pi": self.embedding_2pi,
            "3p": self.embedding_3p,
            "3pt": self.embedding_3pt,
            "3pi": self.embedding_3pi,
            ...
            "ipt": self.embedding_ipt,
            "ipi": self.embedding_ipi,
            "inp": self.embedding_inp,
            "inpt": self.embedding_inpt,
            "inpi": self.embedding_inpi,

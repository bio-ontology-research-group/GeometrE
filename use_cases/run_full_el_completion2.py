...
from src.full_el_completion2 import FullELModel
...
def main(use_case, model_type, num_models, emb_dim, batch_size,
    ...
    wandb_logger = wandb.init(project='onto-r', group=f'trans_{use_case}_{model_type}', name=f'{description}')
